...
module.exports.get = async () => {
    ...
    return await CategoryModel.aggregate([{$lookup: {localField: "_id", foreignField: "categoryId", from: "sub_categories", as: "preferences"}}, {$project: {_id: 1, name: 1, description: 1,preferences: 1}}])
    .then(
        async (data) => {
